...
//http://stackoverflow.com/questions/19675331
//http://stackoverflow.com/questions/15627530
        ...
        post(new Runnable() {
            public void run() {
                if (getLineCount()>MAX_LINES)
                    setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, R.drawable.ic_more_text);
                else
